...
export const skillGroups: SkillGroup[] = [
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Zustand", icon: Package, color: "#C6825A" },
    ],
  },
  {
    id: "backend",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "LightGBM", icon: Trees, color: "#9ACD32" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Matplotlib", icon: ChartLine, color: "#11557C" },
      { name: "Plotly", icon: SiPlotly, color: "#3F4F75" },
      { name: "Tableau", icon: ChartColumn, color: "#E97627" },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "Neon Postgres", icon: SiNeon, color: "#00E599" },
    ],
  },
  {
    id: "tools",
